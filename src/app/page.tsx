      ...
      <div className="flex flex-col min-h-screen bg-background text-foreground selection:bg-primary/20 selection:text-foreground">
            ...
            <nav className="hidden md:flex items-center space-x-1">
              {navItems.map((item) => (
                <Button
                  ...
                  size="sm"
                  asChild
                  className="text-sm font-medium text-muted-foreground hover:text-primary hover:bg-accent/10"
                >
                ...
                <Sheet>
                  ...
                  >
                    <SheetHeader className="mb-6 mt-2">
                      <SheetTitle className="text-left text-lg font-serif font-semibold text-primary tracking-tight">
                        Anubhab Das
                      </SheetTitle>
                      ...
                      {navItems.map((item) => (
                        <SheetTrigger asChild key={item.name}>
                          <Button
                            ...
                            size="lg"
                            asChild
                            className="w-full justify-start text-base text-muted-foreground hover:text-primary hover:bg-accent/10 py-3"
                          >
                            <Link
                              href={item.href}
          ...
          <div className="flex flex-col md:flex-row w-full">
            ...
            <div className="w-full md:w-1/3 lg:w-1/4 md:sticky md:top-16 md:h-[calc(100vh-4rem)] py-8 md:py-12 md:pr-8 lg:pr-10 flex flex-col items-center flex-shrink-0">
              ...
              <div className="w-full flex-grow text-center">
                ...
                <p className="text-sm font-medium tracking-wide text-muted-foreground/80 mt-1.5 mb-7">
                  Student at NIT Rourkela
                </p>
            ...
            <main className="w-full md:w-2/3 lg:w-3/4 md:pl-0 py-12 md:py-16 scroll-smooth space-y-16 md:space-y-24 scroll-pt-[5rem] md:scroll-mt-[5rem]">
              <section
                id="about"
                className="scroll-mt-[5rem] md:scroll-mt-[5rem]"
              >
                <AboutSection />
              </section>
              <section
        ...
        <footer className="w-full py-6 px-4 text-center border-t border-border bg-card">
          <p className="text-xs text-muted-foreground tracking-wide">
            &copy; {year} Anubhab Das. All rights reserved. Built with Next.js,
            Tailwind CSS, and ❤️.
          </p>
        </footer>
      </div>
